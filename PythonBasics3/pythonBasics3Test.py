...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("I love coding"), True)
        self.assertEqual(pythonBasics3.starts_with_non_number("1 love coding"), False)
        self.assertEqual(pythonBasics3.starts_with_non_number("9 love coding"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        self.assertEqual(pythonBasics3.multiple_words("....."), False)
        self.assertEqual(pythonBasics3.multiple_words(" I "), False)
        self.assertEqual(pythonBasics3.multiple_words(" i love coding "), True)
